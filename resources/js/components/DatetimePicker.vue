...
const DEFAULT_CLEAR_TEXT = 'Очистити'
  ...
  computed: {
    ...
    selectedDatetime() {
      if (this.date && this.time) {
        ...
        return parseISO(datetimeString, this.defaultDateTimeFormat, new Date())
      } else {
        return null
      }
    },
  ...
  methods: {
    init() {
      ...
      if (this.datetime instanceof Date) {
        ...
        initDateTime = parseISO(this.datetime, this.dateTimeFormat, new Date())
      }
